package com.kluivert.wissiondemo.Adapter;
...
public  class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.RecyclerViewHolder>{
    ...
    public RecyclerAdapter(Context context, List<Hero> uploads) {
        mContext = context;
        heroes = uploads;
    }
    ...
    public void onBindViewHolder(RecyclerViewHolder holder, int position) {
        ...
        holder.nameTextView.setText(currentHero.getName());
        holder.descriptionTextView.setText(currentHero.getDescription());
